const stripe = Stripe("pk_test_51R7T02BgNkeedNhqYOkFSgPQScP44f2vXamBXFcBdaybvR8rngwdW5lQoXFDEWzwr0rKmgEDFZhoSt0Gg5CMpWYs00XHLgs4Zo");
...
document.getElementById("checkout-button").addEventListener("click", async () => {
    try {
        ...
        console.log("Session ID:", session.id); // Añadir este log para verificar el ID
